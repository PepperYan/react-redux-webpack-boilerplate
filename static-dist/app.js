...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxSimpleRouter = __webpack_require__(225);

	var _history = __webpack_require__(226);

	var _modelsStoreConfigureStore = __webpack_require__(231);

	var _modelsStoreConfigureStore2 = _interopRequireDefault(_modelsStoreConfigureStore);
	...
	//加载自定义Store
	var store = (0, _modelsStoreConfigureStore2['default'])();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersDevTools = __webpack_require__(253);

	var _containersDevTools2 = _interopRequireDefault(_containersDevTools);

	//叠加一些中间件
	var createStoreWithMiddleware = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2['default']), (0, _redux.applyMiddleware)((0, _reduxLogger2['default'])()),
	// devTools()
	_containersDevTools2['default'].instrument())(_redux.createStore);

	//加载reducers

	function configureStore(initialState) {
	  console.log('reducers count:' + _reducers2['default'].length);
	  var store = createStoreWithMiddleware(_reducers2['default'], initialState);

	  if (true) {
	    // Enable Webpack hot module replacement for reducers
	    module.hot.accept(232, function () {
	      var nextReducer = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxUndo = __webpack_require__(233);

	var _reduxUndo2 = _interopRequireDefault(_reduxUndo);

	var _carts = __webpack_require__(234);

	var _carts2 = _interopRequireDefault(_carts);

	var _cargos = __webpack_require__(242);

	var _cargos2 = _interopRequireDefault(_cargos);
	...
	var combine = (0, _redux.combineReducers)({
	  carts: (0, _reduxUndo2['default'])(_carts2['default']), //设定reducer可状态回滚
	  // carts,
	  cargos: _cargos2['default'],
	  detail: _detail2['default'],
	  user: _user2['default'],
	  routing: _reduxSimpleRouter.routeReducer //加入redux-simple-router的reduser
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonCreateReducer = __webpack_require__(235);

	var _commonCreateReducer2 = _interopRequireDefault(_commonCreateReducer);

	var _actionsCarts = __webpack_require__(236);

	var _lodash = __webpack_require__(240);

	var _lodash2 = _interopRequireDefault(_lodash);

	//演示如何在reducer里面嵌入reducer,reducer既可以是普通的function,也可以通过createReducer新建,使用createReducer就不用茫茫的switch
	var insetReucer = function insetReucer(state, action) {
	  var index = _lodash2['default'].findIndex(state, function (cargo) {
	    return cargo.id == action.cargo.id;
	  });
	  if (index !== -1) {
	    // careful!! we should not modify the state.Instead, we return a new array
	    return [].concat(_toConsumableArray(state.slice(0, index)), [Object.assign({}, state[index], { count: state[index].count + 1 })], _toConsumableArray(state.slice(index + 1)));
	  } else {
	    action.cargo.count = 1;
	    return [].concat(_toConsumableArray(state), [action.cargo]);
	  }
	};

	var carts = (0, _commonCreateReducer2['default'])([], (_createReducer = {}, _defineProperty(_createReducer, _actionsCarts.PRE_ADD_TO_CART, function (state, action) {
	  if (state === undefined) state = [];

	  var preCart = insetReucer(state, action);
	  return preCart;
	}), _defineProperty(_createReducer, _actionsCarts.DELETE_CART, function (state, action) {
	  if (state === undefined) state = [];

	  return [].concat(_toConsumableArray(state.slice(0, action.index)), _toConsumableArray(state.slice(action.index + 1)));
	}), _defineProperty(_createReducer, _actionsCarts.REMOVE_CARTS, function (state, action) {
	  if (state === undefined) state = [];

	  var cargosLeft = _lodash2['default'].filter(state, function (cargo) {
	    var index = _lodash2['default'].findIndex(action.cargos, function (sCargo) {
	      return cargo.id == sCargo.id;
	    });
	    if (index !== -1) return false;
	    return true;
	  });
	  return cargosLeft;
	}), _defineProperty(_createReducer, _actionsCarts.REQ_CARTS_SUCCESS, function (state, action) {
	  if (state === undefined) state = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.preAddToCart = preAddToCart;
	exports.deleteCart = deleteCart;
	exports.requestCartSuccess = requestCartSuccess;
	exports.requestCartFail = requestCartFail;
	exports.removeCart = removeCart;
	exports.requestCarts = requestCarts;
	exports.addToCart = addToCart;
	exports.requestDeleteCart = requestDeleteCart;
	...
	var _constantsConfig = __webpack_require__(238);

	var _constantsConfig2 = _interopRequireDefault(_constantsConfig);

	var _utilsUtils = __webpack_require__(239);

	var PRE_ADD_TO_CART = 'PRE_ADD_TO_CART';
	exports.PRE_ADD_TO_CART = PRE_ADD_TO_CART;
	var ADD_TO_CART = 'ADD_TO_CART';
	exports.ADD_TO_CART = ADD_TO_CART;
	var DELETE_CART = 'DELETE_CART';
	exports.DELETE_CART = DELETE_CART;
	var REQ_CARTS_SUCCESS = 'REQ_CARTS_SUCCESS';
	exports.REQ_CARTS_SUCCESS = REQ_CARTS_SUCCESS;
	var REQ_CARTS_ERROR = 'REQ_CARTS_ERROR';
	exports.REQ_CARTS_ERROR = REQ_CARTS_ERROR;
	var REMOVE_CARTS = 'REMOVE_CARTS';

	exports.REMOVE_CARTS = REMOVE_CARTS;
	//先加到state在悄悄提交

	function preAddToCart(cargo) {
	  return {
	    type: PRE_ADD_TO_CART,
	    cargo: cargo
	  };
	}
	...
	function requestCartSuccess(cargos) {
	  return {
	    type: REQ_CARTS_SUCCESS,
	    cargos: cargos
	  };
	}

	function requestCartFail() {
	  return {
	    type: REQ_CARTS_ERROR
	  };
	}

	function removeCart(cargos) {
	  return {
	    type: REMOVE_CARTS,
	    cargos: cargos
	  };
	...
	function requestCarts() {
	  var u_id = (0, _utilsUtils.getUserId)();
	  console.log('request carts');
	  return function (dispatch) {
	    _jquery2['default'].ajax({
	      method: 'GET',
	      url: (0, _constantsConfig2['default'])() + ('/users/' + u_id + '/carProducts'),
	      dataType: 'json'
	    }).done(function (response) {
	      console.log('request carts success');
	      dispatch(requestCartSuccess(response.payload));
	    }).fail(function () {
	      console.log('request carts fail');
	      dispatch(requestCartFail());
	    });
	  };
	}

	//添加商品列表这步采用同步更新状态, 异步提交, 失败回滚策略 ,   ps:实际上这个部分没有什么用,这里只是演示如何回滚事务

	function addToCart(cargo) {
	  console.log('add to cart:' + JSON.stringify(cargo));
	  var u_id = (0, _utilsUtils.getUserId)();
	  var data = { product_id: cargo.id, u_id: u_id };
	  return function (dispatch) {
	    dispatch(preAddToCart(cargo));
	    _jquery2['default'].ajax({
	      url: (0, _constantsConfig2['default'])() + ('/users/' + u_id + '/carProducts'),
	      method: 'POST',
	...
	function requestDeleteCart(cargo, index) {
	  console.log('delete cart');
	  var u_id = (0, _utilsUtils.getUserId)();
	  return function (dispatch) {
	    _jquery2['default'].ajax({
	      url: (0, _constantsConfig2['default'])() + ('/users/' + u_id + '/carProducts/' + cargo.productId),
	      method: 'DELETE',
	      contentType: 'application/json'
	    }).done(function (response) {
	      dispatch(deleteCart(index));
	      console.log('delete cart success:' + response.payload);
	    }).fail(function () {
	      console.log('实施状态回滚');
...
/***/ function(module, exports) {
	...
	function baseUrl() {
	  return 'http://' + config.location + ':' + config.port + config.prefix + config.version;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsCargos = __webpack_require__(243);

	var cargos = (0, _commonCreateReducer2['default'])([], _defineProperty({}, _actionsCargos.FETCH_CARGO_SUCCESS, function (state, action) {
	  console.log('fetching cargos');
	  return [].concat(_toConsumableArray(action.models));
	}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.requestCargos = requestCargos;
	exports.fetchCargoError = fetchCargoError;
	exports.fetchCargoSuccess = fetchCargoSuccess;
	...
	var _fake = __webpack_require__(246);

	var FETCH_CARGO_SUCCESS = 'FETCH_CARGO_SUCCESS';
	exports.FETCH_CARGO_SUCCESS = FETCH_CARGO_SUCCESS;
	var FETCH_CARGO_ERROR = 'FETCH_CARGO_ERROR';
	exports.FETCH_CARGO_ERROR = FETCH_CARGO_ERROR;

	function makeCargoRequest(method, data) {
	  var api = arguments.length <= 2 || arguments[2] === undefined ? '/cargos' : arguments[2];
	...
	function requestCargos() {
	  return function (dispatch) {
	    //调试用
	    dispatch(fetchCargoSuccess(_fake.fakedata.payload));
	    //打开这部分
	    // $.ajax({
	    //   url:baseUrl()+"/products"
	    // })
	    // .done(function(response) {
	    //   dispatch(fetchCargoSuccess(response.payload));
	    // })
	    // .fail(function() {
	    //   dispatch(fetchCargoError());
	    // })

	    // makeCargoRequest('GET')
	    //       .then(response => {
	    //         console.log("获取"+response);
	    //         if (response.status === 200) {
	    //           console.log("获取成功");
	    //           dispatch(fetchCargoSuccess(response.data));
	    //         } else {
	    //           dispatch(fetchCargoError());
	    //         }
	    //       })
	...
	function fetchCargoError() {
	  return {
	    type: FETCH_CARGO_ERROR
	  };
	}

	function fetchCargoSuccess() {
...
/***/ function(module, exports) {
	...
	var fakedata = { "payload": [{ "id": 1, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "12", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 2, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "42", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 3, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "20", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 4, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "15", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 5, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "6", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 6, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "26", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 7, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "30", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 8, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "17", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 9, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "33", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 1, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "12", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }, { "id": 10, "name": "宝马X6/2015款 xDrive35i 尊享型", "price": 1040000.3, "inventory": "46", "desc": "基本参数：任何购车问题请拨打：400-897-3770", "tags": ["50w+", "bmw"], "thumb": "http://car0.autoimg.cn/carnews/2014/11/3/224X168_0_q87_20141103200817538-111.jpg" }], "request_id": "1766fc31-c086-4741-83bb-0d9f72c06bed" };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsUser = __webpack_require__(248);

	var _commonCreateReducer = __webpack_require__(235);

	var _commonCreateReducer2 = _interopRequireDefault(_commonCreateReducer);

	var users = (0, _commonCreateReducer2['default'])([], (_createReducer = {}, _defineProperty(_createReducer, _actionsUser.LOGIN_SUCCESS, function (state, action) {
	  if (state === undefined) state = {};

	  return Object.assign({}, state, _extends({}, action.user, { isShow: false }));
	}), _defineProperty(_createReducer, _actionsUser.IS_SHOW_LOGIN_DIALOG, function (state, action) {
	  if (state === undefined) state = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.login = login;
	exports.isShowLoginDialog = isShowLoginDialog;
	...
	var IS_SHOW_LOGIN_DIALOG = 'IS_SHOW_LOGIN_DIALOG';
	exports.IS_SHOW_LOGIN_DIALOG = IS_SHOW_LOGIN_DIALOG;
	...
	//       dispatch(isShowLoginDialog(true));
	//     }else{
	//       dispatch(isShowLoginDialog(false));
	//     }
	//   }
	// }
	...
	function logout() {
	  return function (dispatch) {
	    (0, _utilsUtils.delete_cookie)('name');
	    (0, _utilsUtils.delete_cookie)('u_id');
	  };
	}
	...
	function login(data) {
	  ...
	  return function (dispatch) {
	    _jquery2['default'].ajax({
	      method: 'POST',
	      url: (0, _constantsConfig2['default'])() + '/users',
	      contentType: 'application/json',
	      dataType: 'json',
	      data: JSON.stringify(data) //这里要转一下
	    }).done(function (response) {
	      //登录成功,信息写入cookie
	      (0, _utilsUtils.writeCookie)('name', response.payload.name, 1);
	      (0, _utilsUtils.writeCookie)('u_id', response.payload.id, 1);
	...
	function isShowLoginDialog() {
	  var isShow = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];

	  return {
	    type: IS_SHOW_LOGIN_DIALOG,
	    isShow: isShow
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsDetail = __webpack_require__(250);

	var detail = (0, _commonCreateReducer2['default'])({}, _defineProperty({}, _actionsDetail.NAV_TO_DETAIL, function (state, action) {
	  if (!action || !action.cargo) return state;
	  return action.cargo;
	}));
...
/***/ function(module, exports) {
	...
	exports.nav2Detail = nav2Detail;
	var NAV_TO_DETAIL = 'NAV_TO_DETAIL';

	exports.NAV_TO_DETAIL = NAV_TO_DETAIL;

	function nav2Detail(cargo) {
	  return {
	    type: NAV_TO_DETAIL,
	    cargo: cargo
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxDevtoolsLogMonitor = __webpack_require__(314);

	var _reduxDevtoolsLogMonitor2 = _interopRequireDefault(_reduxDevtoolsLogMonitor);

	var _reduxDevtoolsDockMonitor = __webpack_require__(453);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _instrument = __webpack_require__(255);
	...
	var _persistState = __webpack_require__(278);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(258),
	    ...
	    createCache = __webpack_require__(262);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var SetCache = __webpack_require__(263),
	    getNative = __webpack_require__(265);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var cachePush = __webpack_require__(264),
	    getNative = __webpack_require__(265);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _identity = __webpack_require__(307);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseMatches = __webpack_require__(282),
	    ...
	    bindCallback = __webpack_require__(306),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var equalArrays = __webpack_require__(286),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arraySome = __webpack_require__(287);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseGet = __webpack_require__(300),
	    ...
	    baseSlice = __webpack_require__(301),
	    isArray = __webpack_require__(276),
	    isKey = __webpack_require__(302),
	    isStrictComparable = __webpack_require__(297),
	    last = __webpack_require__(303),
	    toObject = __webpack_require__(295),
	    toPath = __webpack_require__(304);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LogMonitorEntry = __webpack_require__(316);

	var _LogMonitorEntry2 = _interopRequireDefault(_LogMonitorEntry);

	var _LogMonitorButton = __webpack_require__(409);

	var _LogMonitorButton2 = _interopRequireDefault(_LogMonitorButton);

	var _function = __webpack_require__(407);

	var _function2 = _interopRequireDefault(_function);

	var _reduxDevtoolsThemes = __webpack_require__(411);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactJsonTree = __webpack_require__(317);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inherits = __webpack_require__(318)['default'];

	var _createClass = __webpack_require__(333)['default'];

	var _classCallCheck = __webpack_require__(336)['default'];

	var _extends = __webpack_require__(337)['default'];

	var _interopRequireDefault = __webpack_require__(347)['default'];
	...
	var _grabNode = __webpack_require__(348);

	var _grabNode2 = _interopRequireDefault(_grabNode);

	var _themesSolarized = __webpack_require__(405);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$create = __webpack_require__(319)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(321).getDesc
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(328)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperty = __webpack_require__(334)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cof = __webpack_require__(345);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objType = __webpack_require__(349);

	var _objType2 = _interopRequireDefault(_objType);

	var _JSONObjectNode = __webpack_require__(373);

	var _JSONObjectNode2 = _interopRequireDefault(_JSONObjectNode);

	var _JSONArrayNode = __webpack_require__(386);

	var _JSONArrayNode2 = _interopRequireDefault(_JSONArrayNode);

	var _JSONIterableNode = __webpack_require__(387);

	var _JSONIterableNode2 = _interopRequireDefault(_JSONIterableNode);

	var _JSONStringNode = __webpack_require__(397);

	var _JSONStringNode2 = _interopRequireDefault(_JSONStringNode);

	var _JSONNumberNode = __webpack_require__(399);

	var _JSONNumberNode2 = _interopRequireDefault(_JSONNumberNode);

	var _JSONBooleanNode = __webpack_require__(400);
	...
	var _JSONDateNode = __webpack_require__(402);

	var _JSONDateNode2 = _interopRequireDefault(_JSONDateNode);

	var _JSONUndefinedNode = __webpack_require__(403);

	var _JSONUndefinedNode2 = _interopRequireDefault(_JSONUndefinedNode);

	var _JSONFunctionNode = __webpack_require__(404);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Symbol$iterator = __webpack_require__(350)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(365)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY        = __webpack_require__(356)
	  ...
	  , getProto       = __webpack_require__(321).getProto
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(358)(IteratorPrototype, __webpack_require__(365)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(321).setDesc
	  , has = __webpack_require__(361)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$keys = __webpack_require__(374)['default'];
	...
	var _reactMixin = __webpack_require__(378);

	var _reactMixin2 = _interopRequireDefault(_reactMixin);

	var _mixins = __webpack_require__(381);

	var _JSONArrow = __webpack_require__(385);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(327).Object.keys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mixin = __webpack_require__(379);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequire = __webpack_require__(382)['default'];

	exports.__esModule = true;

	var _squashClickEvent = __webpack_require__(383);

	exports.SquashClickEventMixin = _interopRequire(_squashClickEvent);

	var _expandedStateHandler = __webpack_require__(384);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator = __webpack_require__(388)['default'];

	var _Number$isSafeInteger = __webpack_require__(393)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(327).getIterator = function(it){
	  var iterFn = get(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(327).Number.isSafeInteger;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsHexToRgb = __webpack_require__(398);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _brighten = __webpack_require__(410);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _base16 = __webpack_require__(412);

	_defaults(exports, _interopExportWildcard(_base16, _defaults));

	var _nicinabox = __webpack_require__(450);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _threezerotwofour = __webpack_require__(413);

	exports.threezerotwofour = _interopRequire(_threezerotwofour);

	var _apathy = __webpack_require__(414);

	exports.apathy = _interopRequire(_apathy);

	var _ashes = __webpack_require__(415);

	exports.ashes = _interopRequire(_ashes);

	var _atelierDune = __webpack_require__(416);

	exports.atelierDune = _interopRequire(_atelierDune);

	var _atelierForest = __webpack_require__(417);

	exports.atelierForest = _interopRequire(_atelierForest);

	var _atelierHeath = __webpack_require__(418);

	exports.atelierHeath = _interopRequire(_atelierHeath);

	var _atelierLakeside = __webpack_require__(419);

	exports.atelierLakeside = _interopRequire(_atelierLakeside);

	var _atelierSeaside = __webpack_require__(420);

	exports.atelierSeaside = _interopRequire(_atelierSeaside);

	var _bespin = __webpack_require__(421);

	exports.bespin = _interopRequire(_bespin);

	var _brewer = __webpack_require__(422);

	exports.brewer = _interopRequire(_brewer);

	var _bright = __webpack_require__(423);

	exports.bright = _interopRequire(_bright);

	var _chalk = __webpack_require__(424);

	exports.chalk = _interopRequire(_chalk);

	var _codeschool = __webpack_require__(425);

	exports.codeschool = _interopRequire(_codeschool);

	var _colors = __webpack_require__(426);

	exports.colors = _interopRequire(_colors);

	var _default = __webpack_require__(427);

	exports['default'] = _interopRequire(_default);

	var _eighties = __webpack_require__(428);

	exports.eighties = _interopRequire(_eighties);

	var _embers = __webpack_require__(429);

	exports.embers = _interopRequire(_embers);

	var _flat = __webpack_require__(430);

	exports.flat = _interopRequire(_flat);

	var _google = __webpack_require__(431);

	exports.google = _interopRequire(_google);

	var _grayscale = __webpack_require__(432);

	exports.grayscale = _interopRequire(_grayscale);

	var _greenscreen = __webpack_require__(433);

	exports.greenscreen = _interopRequire(_greenscreen);

	var _harmonic = __webpack_require__(434);

	exports.harmonic = _interopRequire(_harmonic);

	var _hopscotch = __webpack_require__(435);

	exports.hopscotch = _interopRequire(_hopscotch);

	var _isotope = __webpack_require__(436);

	exports.isotope = _interopRequire(_isotope);

	var _marrakesh = __webpack_require__(437);

	exports.marrakesh = _interopRequire(_marrakesh);

	var _mocha = __webpack_require__(438);

	exports.mocha = _interopRequire(_mocha);

	var _monokai = __webpack_require__(439);

	exports.monokai = _interopRequire(_monokai);

	var _ocean = __webpack_require__(440);

	exports.ocean = _interopRequire(_ocean);

	var _paraiso = __webpack_require__(441);

	exports.paraiso = _interopRequire(_paraiso);

	var _pop = __webpack_require__(442);

	exports.pop = _interopRequire(_pop);

	var _railscasts = __webpack_require__(443);

	exports.railscasts = _interopRequire(_railscasts);

	var _shapeshifter = __webpack_require__(444);

	exports.shapeshifter = _interopRequire(_shapeshifter);

	var _solarized = __webpack_require__(445);

	exports.solarized = _interopRequire(_solarized);

	var _summerfruit = __webpack_require__(446);

	exports.summerfruit = _interopRequire(_summerfruit);

	var _tomorrow = __webpack_require__(447);

	exports.tomorrow = _interopRequire(_tomorrow);

	var _tube = __webpack_require__(448);

	exports.tube = _interopRequire(_tube);

	var _twilight = __webpack_require__(449);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DockMonitor = __webpack_require__(454);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDock = __webpack_require__(455);
	...
	var _parseKey = __webpack_require__(502);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequireDefault = __webpack_require__(456)['default'];

	Object.defineProperty(exports, '__esModule', {
	  value: true
	});

	var _Dock = __webpack_require__(458);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(459)['default'];

	var _inherits = __webpack_require__(466)['default'];

	var _createClass = __webpack_require__(478)['default'];

	var _classCallCheck = __webpack_require__(481)['default'];

	var _extends = __webpack_require__(483)['default'];

	var _toConsumableArray = __webpack_require__(485)['default'];

	var _Object$keys = __webpack_require__(494)['default'];
	...
	var _lodashDebounce = __webpack_require__(495);

	var _lodashDebounce2 = _interopRequireDefault(_lodashDebounce);

	var _objectAssign = __webpack_require__(497);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getPrototypeOf = __webpack_require__(460);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(327).Object.getPrototypeOf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(377)('getPrototypeOf', function($getPrototypeOf){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(377)('getOwnPropertyDescriptor', function($getOwnPropertyDescriptor){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _symbol = __webpack_require__(470);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(372)
	  , getNames  = __webpack_require__(321).getNames
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assign = __webpack_require__(484);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var keycodes = __webpack_require__(503);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersApp = __webpack_require__(505);

	var _containersApp2 = _interopRequireDefault(_containersApp);

	var _containersCargos = __webpack_require__(580);

	var _containersCargos2 = _interopRequireDefault(_containersCargos);

	var _containersCart = __webpack_require__(615);

	var _containersCart2 = _interopRequireDefault(_containersCart);

	var _containersDetail = __webpack_require__(620);
	...
	exports['default'] = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(_reactRouter.IndexRoute, { component: _containersCargos2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { path: 'cart', component: _containersCart2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { path: 'detail', component: _containersDetail2['default'] }),
	  ' '
	);
	module.exports = exports['default'];
	/**新的demo页**/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Navigation = __webpack_require__(506);
	...
	var _materialUiLibAppBar = __webpack_require__(507);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      //   matchTitle = this.props.route.indexRoute.title;
	      // }else{
	      //   let path = this.props.location.pathname.substr(1);
	      //   matchTitle = _.result(_.findWhere(this.props.route.childRoutes, { 'path':path }),'title');
	      // }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modelsActionsCargos = __webpack_require__(243);

	var _modelsActionsCarts = __webpack_require__(236);

	var _componentsBussinessItem = __webpack_require__(581);

	var _componentsBussinessItem2 = _interopRequireDefault(_componentsBussinessItem);

	var _reactRedux = __webpack_require__(170);

	var _materialUiLibListsList = __webpack_require__(589);

	var _materialUiLibListsList2 = _interopRequireDefault(_materialUiLibListsList);

	var _materialUiLibDivider = __webpack_require__(583);
	...
	var _materialUiLibIconButton = __webpack_require__(528);

	var _materialUiLibIconButton2 = _interopRequireDefault(_materialUiLibIconButton);

	var _materialUiLibSvgIconsMapsLocalGroceryStore = __webpack_require__(593);

	var _materialUiLibSvgIconsMapsLocalGroceryStore2 = _interopRequireDefault(_materialUiLibSvgIconsMapsLocalGroceryStore);

	var _modelsActionsDetail = __webpack_require__(250);

	var _materialUiLibSvgIconsActionCached = __webpack_require__(594);

	var _materialUiLibSvgIconsActionCached2 = _interopRequireDefault(_materialUiLibSvgIconsActionCached);

	var _modelsActionsUser = __webpack_require__(248);

	var _utilsUtils = __webpack_require__(239);

	var _componentsBussinessLogin = __webpack_require__(595);

	var _componentsBussinessLogin2 = _interopRequireDefault(_componentsBussinessLogin);

	var CargoPage = (function (_Component) {
	  _inherits(CargoPage, _Component);

	  function CargoPage() {
	    _classCallCheck(this, CargoPage);

	    _get(Object.getPrototypeOf(CargoPage.prototype), 'constructor', this).apply(this, arguments);
	  }

	  //<li key={state.id} data-index={state.id} onClick={this.handleSelect.bind(this,dispatch)}>
	  //   <div>{state.name}</div>
	  //   <div>{state.price}</div>
	  ...
	  _createClass(CargoPage, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      dispatch((0, _modelsActionsCargos.requestCargos)());
	    }
	  }, {
	    key: 'handleSelect',
	    value: function handleSelect(dispatch, index) {
	      dispatch((0, _modelsActionsDetail.nav2Detail)(this.props.cargos[index]));
	      this.props.history.pushState(null, '/detail');
	    }
	  }, {
	    key: 'checkLogin',
	    value: function checkLogin() {
	      ...
	      if (!this.props.user.isShow && !(0, _utilsUtils.getCookie)('name')) {
	        dispatch((0, _modelsActionsUser.isShowLoginDialog)(true));
	        return false;
	      }
	      return true;
	    }
	    ...
	    key: 'handleAdd',
	    value: function handleAdd(dispatch, index, e) {
	      e.stopPropagation();
	      ...
	      dispatch((0, _modelsActionsCarts.addToCart)(this.props.cargos[index]));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_materialUiLibAppBar2['default'], {
	          ...
	          iconElementLeft: _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_materialUiLibSvgIconsActionCached2['default'], null)
	          ),
	          iconElementRight: _react2['default'].createElement(
	            ...
	            { onClick: function () {
	                ...
	                _this.props.history.pushState(null, '/cart');
	              } },
	            _react2['default'].createElement(_materialUiLibSvgIconsMapsLocalGroceryStore2['default'], null)
	          )
	        }),
	        _react2['default'].createElement(
	          _materialUiLibListsList2['default'],
	          null,
	          this.props.cargos && this.props.cargos.map(function (state) {
	            var key = index;
	            index++;
	            return _react2['default'].createElement(_componentsBussinessItem2['default'], _extends({ key: key, index: key }, state, { handleAdd: _this.handleAdd.bind(_this, dispatch), handleSelect: _this.handleSelect.bind(_this, dispatch) }));
	          })
	        ),
	        _react2['default'].createElement(_componentsBussinessLogin2['default'], this.props)
	      );
	    }
	  }]);
	...
	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(CargoPage);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _materialUiLibAvatar = __webpack_require__(582);
	...
	var _materialUiLibListsListItem = __webpack_require__(585);

	var _materialUiLibListsListItem2 = _interopRequireDefault(_materialUiLibListsListItem);

	var _materialUiLibFloatingActionButton = __webpack_require__(590);

	var _materialUiLibFloatingActionButton2 = _interopRequireDefault(_materialUiLibFloatingActionButton);

	var _commonsTag = __webpack_require__(591);

	var _commonsTag2 = _interopRequireDefault(_commonsTag);

	var _materialUiLibSvgIconsActionAddShoppingCart = __webpack_require__(592);

	var _materialUiLibSvgIconsActionAddShoppingCart2 = _interopRequireDefault(_materialUiLibSvgIconsActionAddShoppingCart);
	...
	var Item = (function (_Component) {
	  ...
	  //   subtitle={<span><b>{this.props.price}</b></span>}
	  //   actionIcon={<IconButton>no</IconButton>}
	  //   ><img src={'http://www.material-ui.com/images/grid-list/00-52-29-429_640.jpg'} /></GridTile>
	  ...
	  _createClass(Item, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        {
	          leftAvatar: _react2['default'].createElement(_materialUiLibAvatar2['default'], { src: this.props.thumb }),
	          ...
	          onClick: function () {
	            _this.props.handleSelect(_this.props.id);
	          }
	        },
	        _react2['default'].createElement(
	          _materialUiLibIconButton2['default'],
	          { style: { float: "right" }, onClick: function (e) {
	              _this.props.handleAdd(_this.props.index, e);
	            } },
	          _react2['default'].createElement(_materialUiLibSvgIconsActionAddShoppingCart2['default'], null)
	        ),
	        this.props.tags && this.props.tags.map(function (tag) {
	          return _react2['default'].createElement(_commonsTag2['default'], { key: tag, text: tag, style: { float: 'right', marginTop: "1rem", marginLeft: '0.3rem' } });
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(534);

	var _reactAddonsPureRenderMixin2 = _interopRequireDefault(_reactAddonsPureRenderMixin);

	var _svgIcon = __webpack_require__(578);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    dispatch((0, _modelsActionsUser.isShowLoginDialog)(false));
	  },
	  ...
	  handleLogin: function handleLogin() {
	    ...
	    dispatch((0, _modelsActionsUser.login)({ name: this.state.username, password: this.state.password }));
	  },
	  render: function render() {
	    var actions = [_react2['default'].createElement(_materialUiLibFlatButton2['default'], {
	      label: '取消',
	      secondary: true,
	      onClick: this.handleClose }), _react2['default'].createElement(_materialUiLibFlatButton2['default'], {
	      label: '登录',
	      primary: true,
	    ...
	    return _react2['default'].createElement(
	      _materialUiLibDialog2['default'],
	      {
	        ...
	        open: this.props.user.isShow ? this.props.user.isShow : false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _materialUiLibSvgIconsNavigationClose = __webpack_require__(616);

	var _materialUiLibSvgIconsNavigationClose2 = _interopRequireDefault(_materialUiLibSvgIconsNavigationClose);

	var _materialUiLibSvgIconsNavigationChevronLeft = __webpack_require__(617);

	var _materialUiLibSvgIconsNavigationChevronLeft2 = _interopRequireDefault(_materialUiLibSvgIconsNavigationChevronLeft);
	...
	var _modelsActionsOrders = __webpack_require__(618);

	var _materialUiLibRaisedButton = __webpack_require__(619);
	...
	var CartPage = (function (_Component) {
	  ...
	  function CartPage() {
	    ...
	    _get(Object.getPrototypeOf(CartPage.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(CartPage, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      dispatch((0, _modelsActionsCarts.requestCarts)());
	    }
	  }, {
	    key: 'handleDelete',
	    value: function handleDelete(dispatch, dCargo) {
	      var index = _.findIndex(this.props.carts, function (cargo) {
	        return cargo.id == dCargo.id;
	      });
	      dispatch((0, _modelsActionsCarts.requestDeleteCart)(this.props.carts[index], index));
	    }
	  }, {
	    key: 'handleSubmit',
	    value: function handleSubmit() {
	      ...
	      dispatch((0, _modelsActionsOrders.submitOrder)(carts));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_materialUiLibAppBar2['default'], {
	          ...
	          iconElementLeft: _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_materialUiLibSvgIconsNavigationChevronLeft2['default'], null)
	          ),
	          iconElementRight: _react2['default'].createElement(_materialUiLibRaisedButton2['default'], { onClick: this.handleSubmit.bind(this), style: { marginTop: 3 }, label: '结算', primary: true })
	        }),
	        _react2['default'].createElement(
	          _materialUiLibListsList2['default'],
	          null,
	          this.props.carts.length > 0 && this.props.carts.map(function (state) {
	            return _react2['default'].createElement(
	              'div',
	              { key: state.id },
	              _react2['default'].createElement(
	                _materialUiLibListsListItem2['default'],
	                {
	                  leftAvatar: _react2['default'].createElement(_materialUiLibAvatar2['default'], { src: state.thumb }),
	                ...
	                _react2['default'].createElement(
	                  'span',
	                  { style: { color: 'red', position: 'absolute', right: '100', top: '35' } },
	                  'X',
	                  state.count
	                ),
	                _react2['default'].createElement(
	                  _materialUiLibIconButton2['default'],
	                  { style: { float: "right" }, onClick: _this.handleDelete.bind(_this, dispatch, state) },
	...
	function mapStateToProps(state) {
	  return {
	    carts: state.carts.present,
	    user: state.user
	  };
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(CartPage);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.submitOrderFail = submitOrderFail;
	...
	var _carts = __webpack_require__(236);
	...
	var SUBMIT_ORDER_SUCCESS = 'SUBMIT_ORDER_SUCCESS';
	exports.SUBMIT_ORDER_SUCCESS = SUBMIT_ORDER_SUCCESS;
	var SUBMIT_ORDER_FAIL = 'SUBMIT_ORDER_FAIL';

	exports.SUBMIT_ORDER_FAIL = SUBMIT_ORDER_FAIL;

	function submitOrderSuccess(cargos) {
	  return {
	...
	function submitOrder(cargos) {
	  console.log('dispatch');
	  var u_id = (0, _utilsUtils.getUserId)();
	  return function (dispatch) {
	    _jquery2['default'].ajax({
	      method: 'POST',
	      url: (0, _constantsConfig2['default'])() + ('/users/' + u_id + '/orders'),
	      contentType: 'application/json',
	      dataType: 'json',
	      data: { datas: cargos }
	    }).done(function (response) {
	      console.log('success' + JSON.stringify(cargos));
	      var cargosSuccess = cargos;
	      if (typeof response.payload != "string") {
	        cargosSuccess = response.payload;
	      }
	      dispatch(submitOrderSuccess(cargosSuccess));
	      dispatch((0, _carts.removeCart)(cargosSuccess));
	    }).fail(function (response) {
	      dispatch(submitOrderFail(response.payload));
	      console.log('fail');
	    });
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCommonsSwiper = __webpack_require__(621);

	var _componentsCommonsSwiper2 = _interopRequireDefault(_componentsCommonsSwiper);
	  ...
	  **/
	  ...
	  _createClass(Detail, [{
	    ...
	    value: function handleAdd() {
	      ...
	      dispatch((0, _modelsActionsCarts.addToCart)(this.props.detail));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'section',
	              { className: 'detail-section gallery' },
	              _react2['default'].createElement(
	                _componentsCommonsSwiper2['default'],
	                null,
	                _react2['default'].createElement(
	                  'div',
	                  null,
	                  _react2['default'].createElement('img', { key: '1', src: this.props.detail ? this.props.detail.thumb : '', style: { height: '20rem', width: '100%' } })
	                ),
	                _react2['default'].createElement(
	                  'div',
	                  null,
	                  _react2['default'].createElement('img', { key: '2', src: this.props.detail ? this.props.detail.thumb : '', style: { height: '20rem', width: '100%' } })
	                ),
	                _react2['default'].createElement(
	                  'div',
	                  null,
	                  _react2['default'].createElement('img', { key: '3', src: this.props.detail ? this.props.detail.thumb : '', style: { height: '20rem', width: '100%' } })
	                )
	              )
	            ),
	            _react2['default'].createElement(_materialUiLibDivider2['default'], null),
	            _react2['default'].createElement(
	              'section',
	              { className: 'detail-section', style: { fontSize: 16 } },
	              _react2['default'].createElement(
	                'div',
	                null,
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'div',
	                { className: 'cell', style: { maxWidth: 70 } },
	                _react2['default'].createElement(
	                  'div',
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'div',
	                  { className: 'actionbarBtn cart', onClick: this.handleAdd.bind(this) },
	                  '加入购物车'
	                )
	              )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSwipe = __webpack_require__(622);
	...
	var Swiper = (function (_Component) {
	  ...
	  function Swiper(props) {
	    ...
	    _get(Object.getPrototypeOf(Swiper.prototype), 'constructor', this).call(this, props);
	    this.state = { current: 0 };
	  }

	  _createClass(Swiper, [{
	    key: 'onSwiped',
	    value: function onSwiped(index) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { style: { position: 'absolute', top: '93%', textAlign: 'center', right: '0', left: '0' } },
	          this.props.children && this.props.children.map(function (child) {
	            index++;
	            if (current === index) {
	              return _react2['default'].createElement('i', { key: index, style: Object.assign({}, dotStyle, { backgroundColor: 'red' }) });
	            }
	            return _react2['default'].createElement('i', { key: index, style: dotStyle });
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".footer {\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n}\n.footer .actionbar {\n  display: flex;\n  display: -webkit-flex;\n  display: -webkit-box-flex;\n  display: -ms-flex;\n  border-top: 1px solid #E5E5E5;\n}\n.footer .actionbar .cell {\n  flex: 1;\n  height: 49px;\n  text-align: center;\n  position: relative;\n  display: block;\n}\n.footer .actionbar .actionbarBtn {\n  height: 100%;\n  width: 100%;\n  line-height: 49px;\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n.footer .actionbar .actionbarBtn.cart {\n  background-color: #ffb03f;\n  color: white;\n}\n.detail-section {\n  padding: 1rem 0rem;\n  margin-left: 0.5rem;\n}\n.detail-section.gallery {\n  padding: 0rem 0rem;\n  position: relative;\n  margin-left: 0;\n}\n.detail-section .price-tag {\n  color: red;\n  font-size: 23px;\n  font-family: 'Helvetica';\n  margin-top: 0.5rem;\n}\n.nav-bar {\n  position: fixed !important;\n}\n.nav-bar + * {\n  padding-top: 64px !important;\n}\n", ""]);
